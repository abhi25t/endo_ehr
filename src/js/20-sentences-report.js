...
function _sentencesCreateModal() {
  ...
  header.innerHTML =
    '<h2 class="text-xl font-bold text-gray-800">' + (PAGE_TITLES[procedureType] || PAGE_TITLES.endoscopy).replace(' Report', '') + ' — Sentences Report</h2>' +
...
async function _sentencesGeneratePdf() {
  ...
  try {
    ...
    title.textContent = PAGE_TITLES[procedureType] || PAGE_TITLES.endoscopy;
